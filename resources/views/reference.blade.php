                ...
                <div class="row m-5" style="padding-bottom: 2rem">
                            ...
                            <div class="card-body">   
                                ...
                                <div class = "row m-1">
                                        ...
                                        <div class="col-md-10 col-form-label">
                                                <select name="show_name" id="show_name" class="form-control dynamic" data-dependent="request_id" required>
                                        ...
                                        <div class="col-md-10 col-form-label">
                                                <select name="bookingeditingdetail_line" id="bookingeditingdetail_line" class="form-control dynamics" onchange="autofill()" required>
                    ...
                    <div class="row m-5" style="padding-bottom:2rem">
                        <div class="col-sm-12">
                            ...
                            <br>
                            <input class="form-control search-input" type="search" placeholder="Search Data..." data-table="logediting-list" style="width: 300px;margin-right: auto;float: left; margin-bottom:20px;" />
                            ...
                            <table class="table table-sm-9 table-bordered logediting-list">
                                ...
                                <tbody class="table-body text-center">
                                    ...
                                    @if (($r->logediting_generatedby) == (session()->get('nik')))
                                        ...
                                        <td>{{ $r->logediting_requestid }}</td>
                                        <td>{{ $r->logediting_prabudgetid }}</td>
